...
protocol MagnifyingGlassViewDelegate: NSObjectProtocol {
...
public class MagnifyingGlassView: UIView {
    ...
    weak var magnifyingGlassViewDelegate: MagnifyingGlassViewDelegate?
    ...
    public override func draw(_ rect: CGRect) {
       ...
       // magnifiedView?.addSubview(self)
        print("selfff  ", self.frame.origin)
        self.frame.origin = .zero
        self.magnifyingGlassViewDelegate?.addAsSubView(sub: self)
    }
